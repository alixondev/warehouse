...
import com.example.springexam.security.JwtFilter;
...
//                .antMatchers("/api/article/delete/**").hasAuthority("DELETE_ARTICLE")
//                .antMatchers("/api/article/add/**").hasAuthority("ADD_ARTICLE")
//                .antMatchers("/api/article/all/**").hasAuthority("VIEW_ARTICLE")
//                .and()
